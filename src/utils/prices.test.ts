...
describe('prices', () => {
  const token1 = new Token(ChainID.HmyMainnet, '0x0000000000000000000000000000000000000001', 18)
  const token2 = new Token(ChainID.HmyMainnet, '0x0000000000000000000000000000000000000002', 18)
  const token3 = new Token(ChainID.HmyMainnet, '0x0000000000000000000000000000000000000003', 18)
