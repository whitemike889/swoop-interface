...
//import { JSBI, TokenAmount, ETHER } from '@swoop-exchange/sdk'
import { JSBI, TokenAmount, WONE } from '@swoop-exchange/sdk'
...
export default function Manage({
  ...
  // todo
  const token = currencyA === WONE[1] ? tokenB : tokenA
  const WETH = currencyA === WONE[1] ? tokenA : tokenB
