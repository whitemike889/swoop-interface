...
import {useEthereumWalletModalToggle, useWalletModalToggle} from '../../state/application/hooks';
...
// todo disconnect
function Web3StatusInnerMetaMask() {
  ...
  return (
    <div style={{marginLeft: 10}}>
      {isConnected && account ?
        ...
        </Web3StatusConnected> : isConnected ?
          <Web3StatusConnect id="connect-wallet" onClick={() => setConnectMetaMask(true)} faded={!account}>
            <Text>{'Connect to an Ethereum wallet'}</Text>
          </Web3StatusConnect> :
...
export default function Web3Status() {
  ...
  return (
    <>
      <Web3StatusInner />
      <Web3StatusInnerMetaMask />
      <WalletModal ENSName={ENSName ?? undefined} pendingTransactions={pending} confirmedTransactions={confirmed} />
      <WalletEthereumModal ENSName={ENSName ?? undefined} pendingTransactions={pending} confirmedTransactions={confirmed} />
    </>
  );
}
